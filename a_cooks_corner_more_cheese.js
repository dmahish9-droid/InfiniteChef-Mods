//i did not actually make this mod i just copied it
//hi
...
addIngredient("chocolate_cheese",{
    type:"cheese",
    color:"#8B6F63",
});
addIngredient("soy_cheese",{
    type:"cheese",
    color:"#DCB300",
});
addIngredient("almond_cheese",{
    type:"cheese",
    color:"#FFD000",
});
addIngredient("coconut_cheese",{
    type:"cheese",
    color:"#C2BA3A",
});
addIngredient("jelly",{
...
editIngredient("vinegar",{
    reactions: {
        ...
        chocolate_milk:{ set1: null, set2:"chocolate_cheese" },
        pumpkin_soup:{ set1: null, set2:"pumpkin_cheese" },
        soy_milk:{ set1: null, set2:"soy_cheese" },
        almond_milk:{ set1: null, set2:"almond_cheese" },
        coconut_milk:{ set1: null, set2:"coconut_cheese" },
    },
});
...
addRecipe("&bowl:rice+milk","rice pudding");

addRecipe("&stack:fruit+sugar+bread","fruit tart");

addRecipe("&bowl:pumpkin+milk","pumpkin_soup");
